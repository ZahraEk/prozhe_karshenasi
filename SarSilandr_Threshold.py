...
#khandane aksha
img_cut = cv.imread("images/SilandrCut2933.jpg")
img_cut1 = cv.cvtColor(img_cut, cv.COLOR_BGR2RGB)

img_gray = cv.imread('images/SilandrCl2933.jpg',0)

org_img = cv.imread('images/IMG_2933.JPG')
...
#silandr 2933 :
ret,trs = cv.threshold(img_gray,163,250,cv.THRESH_BINARY)
...
#save kardane aksha
mask = cv.imwrite('images/SilandrMask2933.jpg', trs)
result = cv.imwrite('images/SilandrRes2933.jpg', res2)
